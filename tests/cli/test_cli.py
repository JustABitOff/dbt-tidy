...
def test_sweep_manifestv10(mock_load_manifest, manifestv10_fixture):
    runner = click.testing.CliRunner()
    
    mocked_manifest = manifestv10_fixture
...
@patch("tidy.manifest.ManifestWrapper.load", autospec=True)
def test_sweep_manifestv11(mock_load_manifest, manifestv11_fixture):
    runner = click.testing.CliRunner()
    
    mocked_manifest = manifestv11_fixture
...
@patch("tidy.manifest.ManifestWrapper.load", autospec=True)
def test_sweep_manifestv12(mock_load_manifest, manifestv12_fixture):
    runner = click.testing.CliRunner()
    
    mocked_manifest = manifestv12_fixture
