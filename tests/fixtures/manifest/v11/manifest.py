...
@pytest.fixture
def manifestv11_direct_join_to_source_fixture():
    return ManifestV11(
        metadata=ManifestMetadata(
            project_name=PACKAGE_NAME,
        ),
...
@pytest.fixture
def manifestv11_model_fanout_fixture():
    return ManifestV11(
        metadata=ManifestMetadata(
            project_name=PACKAGE_NAME,
        ),
...
@pytest.fixture
def manifestv11_multiple_sources_joined_fixture():
    return ManifestV11(
        metadata=ManifestMetadata(
            project_name=PACKAGE_NAME,
        ),
...
@pytest.fixture
def manifestv11_root_models_fixture():
    return ManifestV11(
        metadata=ManifestMetadata(
            project_name=PACKAGE_NAME,
        ),
