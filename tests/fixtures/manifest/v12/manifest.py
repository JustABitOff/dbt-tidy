...
@pytest.fixture
def manifestv12_direct_join_to_source_fixture():
    return ManifestV12(
        metadata=ManifestMetadata(
            project_name=PACKAGE_NAME,
        ),
...
@pytest.fixture
def manifestv12_duplicate_sources_fixture():
    return ManifestV12(
        metadata=ManifestMetadata(
            project_name=PACKAGE_NAME,
        ),
...
@pytest.fixture
def manifestv12_model_fanout_fixture():
    return ManifestV12(
        metadata=ManifestMetadata(
            project_name=PACKAGE_NAME,
        ),
        nodes={
            ...
            f"model.{PACKAGE_NAME}.fct_three": Model(
                database="unit_test_db",
                schema="marts",
                name="fct_three",
                resource_type="model",
            ...
            f"model.{PACKAGE_NAME}.fct_four": Model(
                database="unit_test_db",
                schema="marts",
                name="fct_four",
                resource_type="model",
            ...
            f"model.{PACKAGE_NAME}.fct_five": Model(
                database="unit_test_db",
                schema="marts",
                name="fct_five",
                resource_type="model",
...
@pytest.fixture
def manifestv12_multiple_sources_joined_fixture():
    return ManifestV12(
        metadata=ManifestMetadata(
            project_name=PACKAGE_NAME,
        ),
...
@pytest.fixture
def manifestv12_root_models_fixture():
    return ManifestV12(
        metadata=ManifestMetadata(
            project_name=PACKAGE_NAME,
        ),
