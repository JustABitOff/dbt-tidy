...
class ColumnLevelConstraintFactory(factory.Factory):
    ...
    type = factory.Iterator(["check", "not_null", "unique", "primary_key", "foreign_key", "custom"])
...
class ColumnInfoFactory(factory.Factory):
    ...
    constraints = factory.List([factory.SubFactory(ColumnLevelConstraintFactory) for _ in range(2)])
