...
class TestMultipleSourcesJoinedPass:
...
class TestMultipleSourcesJoinedFail:
    def test_manifestv10(
        self, manifestv10_multiple_sources_joined_fixture, tidy_config_fixture
    ):
        self._run_cli(
            mocked_manifest=manifestv10_multiple_sources_joined_fixture,
            tidy_config_fixture=tidy_config_fixture,
        )

    def test_manifestv11(
        self, manifestv11_multiple_sources_joined_fixture, tidy_config_fixture
    ):
        self._run_cli(
            mocked_manifest=manifestv11_multiple_sources_joined_fixture,
            tidy_config_fixture=tidy_config_fixture,
        )

    def test_manifestv12(
        self, manifestv12_multiple_sources_joined_fixture, tidy_config_fixture
    ):
        self._run_cli(
            mocked_manifest=manifestv12_multiple_sources_joined_fixture,
            tidy_config_fixture=tidy_config_fixture,
        )
